...
def get_translation_url(
    sentance: str, to_language: str, source_language: str = "auto"
) -> str:
...
async def get_translated_coroutine(
    loop, sentance: str, to_lang: str, source_lang="auto"
) -> str:
...
async def translate_async(
    loop, sentances: list, to_lang: str, source_lang: str = "auto"
) -> list:
...
def translate_sentances(
    sentances: list, to_lang: str, source_lang: str = "auto"
) -> list:
...
def run() -> None:
    ...
    def without_async() -> None:
        print(
            "\n".join(
                translate_sync(sentance, dst_lang, src_lang) for sentance in sentances
            )
        )
